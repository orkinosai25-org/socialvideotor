...
{
    Task<RawClipJob> StartProcessingAsync(Stream videoStream, string filename, long fileSize, string userId = "anonymous", CancellationToken cancellationToken = default);
